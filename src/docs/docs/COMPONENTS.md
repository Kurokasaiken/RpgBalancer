...
This document provides a comprehensive overview of all React components in the RPG Balancer application, detailing their props, usage, and responsibilities. Updated for Archmage integration: reusable components tagged for spell-creature and mental palace systems.
...
## Archmage Component Extensions

The following components are planned or extended for Archmage:

- **SpellCreatureCard** [New]: Displays creature lifecycle, mood, and attributes using reusable StatSlider components.
- **MentalPalaceDistrict** [New]: Visualizes palace rooms and mana flow with drag-and-drop expansion.
- **ExpeditionSimulator** [Extension]: Tactical duel viewer for creature combats, adapting ArchetypeBalanceCard logic.
- **MoodIndicator** [New]: Shows creature emotional state with Wanderlust theming.

Existing balancing components (ArchetypeBalanceCard, StatSlider, GenericParamCard, etc.) are **[Reusable]** for creature and palace stats. Legacy PunchClub-specific components may be archived once Archmage UI is implemented.

See `docs/archmage/TechnicalDirection.md` for UI guidelines.
