...
The Spell Creator treats every stat as unaffiliated with rigid categories. Each field has an explicit weight, range, and description defined in `spellBalancingConfig`. Designers can combine them in qualsiasi ordine usando lo Stats Grid.
