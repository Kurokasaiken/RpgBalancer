...
The architecture now supports the Archmage direction with spell-creature and mental palace systems. The Weight-Based Creator Pattern applies to creature attributes, palace room stats, and transcendence mechanics. See `docs/archmage/README.md` for the full documentation hub.
