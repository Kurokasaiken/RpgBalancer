...
Once art assets migrate to the Wanderlust DNA, update these templates with the new palette: vivid turquoise, lime green, bright orange flowers, polished bronze. Use the canonical bible in `src/docs/docs/plans/art_direction_plan.md` for prompt guardrails.

See `docs/archmage/ArtDirection_Wanderlust.md` for details.
