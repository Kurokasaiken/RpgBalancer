...
| `/trailer` | Steam Teaser Trailer | `src/ui/idleVillage/trailer/TrailerViewer.tsx` | **Marketing** | Trailer deterministico da 55 secondi con 7 scene (Threat, Choice, Preparation, Risk, Consequence, Legacy, Outro). | `TrailerViewer`, `TrailerThreat`, `TrailerChoice`, `TrailerPreparation`, `TrailerConsequence`, `TrailerLegacy`, `TrailerOutro`, `AstrolabeTrailerController` |
| `/trailer-threat` | Trailer: Threat | `src/ui/idleVillage/trailer/TrailerThreatPage.tsx` | **Marketing** | Scene 1 — Goblin Invasion with V9 Explorer Journal theme. | `TrailerThreat` |
| `/trailer-choice` | Trailer: Choice | `src/ui/idleVillage/trailer/TrailerChoicePage.tsx` | **Marketing** | Scene 2 — Branching Choice with V9 Explorer Journal theme. | `TrailerChoice` |
| `/trailer-preparation` | Trailer: Preparation | `src/ui/idleVillage/trailer/TrailerPreparationPage.tsx` | **Marketing** | Scene 3 — Hero Preparation with V9 Explorer Journal theme. | `TrailerPreparation` |
| `/trailer-risk` | Trailer: Risk | `src/ui/idleVillage/trailer/TrailerRiskPage.tsx` | **Marketing** | Scene 4 — Astrolabe Risk with V9 Explorer Journal theme. | `AstrolabeTrailerController` |
