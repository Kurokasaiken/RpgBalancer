...
import type { CombatResult, EntityStats } from '../types';
...
const createMockEntity = (name: string): EntityStats => ({
    name,
    ...BASELINE_STATS,
    attack: BASELINE_STATS.damage,
    defense: BASELINE_STATS.armor,
});

describe('MonteCarloSimulation', () => {
    const mockEntity1 = createMockEntity('Entity 1');
    const mockEntity2 = createMockEntity('Entity 2');
