...
export const BALANCING_CONFIG = {
    ...
    // Stress Testing Synergy Thresholds
    OP_SYNERGY_THRESHOLD: 1.15, // Multiplier threshold for OP synergies
    WEAK_SYNERGY_THRESHOLD: 0.95, // Multiplier threshold for weak synergies
} as const;
