...
describe.skip('MathEngine', () => {
    ...
    describe('calcEDPT', () => {
        it('should return 0 for zero damage', () => {
            ...
            const result = MathEngine.calcEDPT(attacker, defender);
            expect(result).toBe(0);
        });
        ...
        it('should be symmetric for mirror match', () => {
            ...
            const edpt1 = MathEngine.calcEDPT(stats, stats);
            const edpt2 = MathEngine.calcEDPT(stats, stats);
        ...
        it('should decrease with armor', () => {
            ...
            const edptLow = MathEngine.calcEDPT(attacker, lowArmor);
            const edptHigh = MathEngine.calcEDPT(attacker, highArmor);
        ...
        it('should subtract regen', () => {
            ...
            const edptNoRegen = MathEngine.calcEDPT(attacker, noRegen);
            const edptWithRegen = MathEngine.calcEDPT(attacker, withRegen);
