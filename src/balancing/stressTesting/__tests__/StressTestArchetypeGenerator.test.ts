...
describe('StressTestArchetypeGenerator', () => {
  ...
  describe('generateBaselineArchetype', () => {
    it('should generate baseline with default stat values', () => {
      ...
      expect(baseline.name).toBe('Baseline Archetype');
  ...
  describe('generateSingleStatArchetypes', () => {
    it('should generate archetypes for each non-derived stat', () => {
      const archetypes = generator.generateSingleStatArchetypes();
  ...
  describe('generatePairStatArchetypes', () => {
    it('should generate archetypes for all C(n,2) combinations of non-derived stats', () => {
      const archetypes = generator.generatePairStatArchetypes();
      ...
      expect(consoleSpy).toHaveBeenCalledWith('[StressTestArchetypeGenerator] Generating pair-stat archetypes from 3 base stats (3 combinations)');
      expect(consoleSpy).toHaveBeenCalledWith('[StressTestArchetypeGenerator] Generated 3 pair-stat archetypes');
    });
  });

  describe('generateAllStressTestArchetypes', () => {
    it('should generate baseline, single, and pair archetypes', () => {
  ...
  describe('deterministic generation', () => {
    it('should generate identical archetypes with same seed', () => {
    ...
    it('should generate different archetypes with different seeds', () => {
      const generator1 = new StressTestArchetypeGenerator(mockConfig, 123);
      ...
      expect(archetypes1).not.toEqual(archetypes2);
      expect(archetypes1.every(a => a.seed === 123)).toBe(true);
