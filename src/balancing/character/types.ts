...
export interface Character {
    ...
    /** Optional visual profile reference for portrait resolution */
    visualProfileId?: string;

    /** Optional direct portrait URL override */
    portraitUrl?: string;

    /** Optional full-figure illustration URL */
    fullFigureUrl?: string;

    /** Optional portrait crop override for badge rendering */
