...
describe('Spell Creation Module', () => {
    ...
    it('should not have deleted fields in default spell', () => {
        ...
        expect((spell as unknown as Record<string, unknown>).castTime).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).charges).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).channel).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).reflection).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).legendary).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).doubleSpell).toBeUndefined();
        expect((spell as unknown as Record<string, unknown>).maxStacks).toBeUndefined();
    });
