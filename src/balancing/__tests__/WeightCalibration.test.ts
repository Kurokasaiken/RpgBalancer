...
function binarySearchWeight(
    ...
    for (let i = 0; i < MAX_ITERATIONS; i++) {
        ...
        const baseStatValue = Number(DEFAULT_STATS[statName as keyof typeof DEFAULT_STATS] ?? 0);
        const statOverride: Partial<StatBlock> = { [statName]: baseStatValue + statAmount };
