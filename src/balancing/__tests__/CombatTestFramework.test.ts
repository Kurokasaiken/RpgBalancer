...
describe.skip('Combat Test Framework', () => {
    ...
    describe('Baseline Tests', () => {
        ...
        it('Symmetry Test should pass', () => {
            const symmetryTest = BASELINE_TESTS.find((t: TestScenario) => t.name === 'Symmetry Test')!;
        ...
        it('HP Scaling Test should show advantage', () => {
            const hpTest = BASELINE_TESTS.find((t: TestScenario) => t.name.includes('HP Scaling'))!;
            const result = runScenario(hpTest, DEFAULT_STATS);
        ...
        it('Damage Scaling Test should show advantage', () => {
            const damageTest = BASELINE_TESTS.find((t: TestScenario) => t.name.includes('Damage Scaling'))!;
            const result = runScenario(damageTest, DEFAULT_STATS);
    ...
    describe('Custom Scenarios', () => {
        it('should handle extreme HP difference', () => {
            const extremeHPTest: TestScenario = {
            ...
            const result = runScenario(extremeHPTest, DEFAULT_STATS);
        ...
        it('should detect unbalanced scenarios', () => {
            const unbalancedTest: TestScenario = {
            ...
            const result = runScenario(unbalancedTest, DEFAULT_STATS);
