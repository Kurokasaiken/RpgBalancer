...
import type { SpellBalancingConfig } from '../../spellBalancingConfig';
import spellBalancingDefaults from '../../spellBalancingConfig.json';

const DEFAULT_SPELL_LEVEL =
  (spellBalancingDefaults as SpellBalancingConfig).baseline.spellLevel ?? 0;
