...
// ============================================================================
// TURNS CURRENCY MODULES (Phase 10 - New Implementation)
// ============================================================================

export { ImpactModule } from './impact';
// Status: ✅ NEW - Phase 10 implementation
// Formulas: Early/Late game impact analysis, burst vs attrition
// Usage: Balancer config, scenario validation, Monte Carlo integration

export { ResourceModule } from './resource';
// Status: ✅ NEW - Phase 10 implementation
// Formulas: Resource efficiency, tempo analysis, sustainability
// Usage: Mana/stamina/energy balancing, cooldown management

export { RiskModule } from './risk';
// Status: ✅ NEW - Phase 10 implementation
// Formulas: Risk-adjusted effectiveness, drawback analysis
// Usage: High-risk/high-reward ability balancing

export { DefenseSpecialsModule } from './defenseSpecials';
// Status: ✅ NEW - Phase 10 implementation
// Formulas: Anti-crit, CC resistance, damage reflection
// Usage: Defensive ability balancing, tank calculations

export { AoEDotModule } from './aoeDot';
// Status: ✅ NEW - Phase 10 implementation
// Formulas: AoE distribution, DOT effectiveness, multi-hit
// Usage: Area ability balancing, DOT optimization
