...
export const eventReminderTokens: EventReminderTokens = {
  ...
  v2: {
    ...
    plaqueBg: 'linear-gradient(135deg, rgba(8,18,31,0.95) 0%, rgba(2,10,14,0.98) 100%)',
    plaqueShine: 'radial-gradient(ellipse at 50% -20%, rgba(255,255,255,0.14) 0%, transparent 40%)',
    plaqueShadow: 'inset 0 1px 0 rgba(255,255,255,0.12), 0 6px 14px rgba(0,118,130,0.15), 0 4px 8px rgba(0,0,0,0.4)',
    glare: 'radial-gradient(ellipse at 12% 10%, rgba(255,255,255,0.16) 0%, transparent 32%)',
    surfaceTexture: 'radial-gradient(ellipse at 25% 20%, rgba(0,118,130,0.12) 0%, transparent 40%), radial-gradient(ellipse at 80% 90%, rgba(0,200,170,0.10) 0%, transparent 45%), linear-gradient(135deg, rgba(255,255,255,0.03) 0%, rgba(0,0,0,0.15) 100%)',
    poiScale: 0.78,
    poiGlowOpacity: 0.22,
