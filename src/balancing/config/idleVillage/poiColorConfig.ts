...
const POI_COLOR_CONFIGS: Record<string, PoiColorConfig> = {
  ...
  quest: {
    coronaCore: { r: 45, g: 195, b: 180 },
    coronaGlow: { r: 30, g: 155, b: 145 },
    rimColors: ['#a0f5e8', '#30c0b0', '#0a2f2a'],
    stoneColors: ['#071a18', '#020808'],
    stoneAmbient: 'rgba(120,255,235,.22)',
    pinColor: 'rgba(120,235,215,.72)',
  },
  job: {
    coronaCore: { r: 230, g: 45, b: 45 },
    coronaGlow: { r: 190, g: 25, b: 25 },
    rimColors: ['#ffb0a0', '#d03030', '#3a1010'],
    stoneColors: ['#2a0a0a', '#120202'],
    stoneAmbient: 'rgba(255,160,150,.22)',
    pinColor: 'rgba(230,160,150,.72)',
  },
  event: {
    coronaCore: { r: 210, g: 138, b: 28 },
    coronaGlow: { r: 180, g: 105, b: 10 },
