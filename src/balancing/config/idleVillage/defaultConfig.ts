...
export const DEFAULT_IDLE_VILLAGE_CONFIG: IdleVillageConfig = {
  ...
  resources: {
    ...
    // Quest item resources (migrated from C1 quest rewards)
    bandit_loot: {
      id: 'bandit_loot',
      label: 'Bandit Loot',
      description: 'Salvaged supplies from defeated bandits.',
      icon: '🎒',
    ...
    ancient_artifact: {
      ...
      description: 'Relics recovered from pre-war ruins.',
      icon: '🏺',
    ...
    rare_scroll: {
      id: 'rare_scroll',
      label: 'Rare Scroll',
      description: 'Fragments of forgotten knowledge.',
      icon: '📜',
    ...
    healing_herb: {
      id: 'healing_herb',
      label: 'Healing Herb',
      description: 'Medicinal plants for the village healer.',
      icon: '🌿',
      colorClass: 'text-emerald-300',
    },
    rare_herb: {
      id: 'rare_herb',
      label: 'Rare Herb',
      description: 'Uncommon herbs with potent properties.',
      icon: '🌱',
  ...
  activities: {
    ...
    // Migrated C1 quests — now expressed as C2 ActivityDefinitions.
    'bandit-camp-demo': {
      id: 'bandit-camp-demo',
      label: 'Bandit Camp',
      description: 'Track down and eliminate bandit camps threatening the village.',
      tags: ['quest', 'combat', 'bandit'],
      cardKind: 'quest',
      slotTags: ['world', 'danger_zone'],
      resolutionEngineId: 'questPower',
      level: 3,
      dangerRating: 4,
      durationFormula: '4',
      maxSlots: 3,
      statRequirement: {
        label: 'Strength + (Endurance | Agility | Intelligence | Perception)',
        allOf: ['strength'],
        anyOf: ['endurance', 'agility', 'intelligence', 'perception'],
      },
      rewards: [
        { resourceId: 'gold', amountFormula: '50' },
        { resourceId: 'xp', amountFormula: '100' },
        { resourceId: 'bandit_loot', amountFormula: '1' },
      ],
      metadata: {
        icon: '⚔️',
        narrative: 'Track down and eliminate bandit camps threatening the village.',
        injuryChanceDisplay: 35,
        deathChanceDisplay: 8,
        questDifficulty: 1.35,
        difficultyLabel: 'Medio',
        varianceCategory: 'risky',
        durationHours: 4,
        slotBlueprints: [
          {
            id: 'bandit-camp-demo-slot-0',
            label: 'Vanguard',
            role: 'vanguard',
            required: true,
            requirement: { label: 'Vanguard', anyOf: ['strength', 'fortitude'] },
          },
          {
            id: 'bandit-camp-demo-slot-1',
            label: 'Support',
            role: 'support',
            required: false,
            requirement: { label: 'Support', anyOf: ['agility', 'perception', 'intelligence', 'endurance'] },
          },
          {
            id: 'bandit-camp-demo-slot-2',
            label: 'Support',
            role: 'support',
            required: false,
            requirement: { label: 'Support', anyOf: ['agility', 'perception', 'intelligence', 'endurance'] },
    ...
    'ancient-ruins': {
      ...
      tags: ['quest', 'exploration', 'ancient'],
      cardKind: 'quest',
      slotTags: ['world', 'danger_zone'],
      resolutionEngineId: 'questPower',
      level: 5,
      ...
      maxSlots: 4,
      statRequirement: {
        label: 'Intelligence + (Perception | Agility | Endurance)',
        allOf: ['intelligence'],
        anyOf: ['perception', 'agility', 'endurance'],
      },
      rewards: [
        { resourceId: 'gold', amountFormula: '100' },
        { resourceId: 'xp', amountFormula: '200' },
        { resourceId: 'ancient_artifact', amountFormula: '1' },
        { resourceId: 'rare_scroll', amountFormula: '2' },
      ],
      metadata: {
        icon: '🏛️',
        narrative: 'Explore mysterious ruins and uncover ancient secrets.',
        injuryChanceDisplay: 25,
        deathChanceDisplay: 5,
        questDifficulty: 1.6,
        difficultyLabel: 'Alto',
        varianceCategory: 'risky',
        durationHours: 6,
        slotBlueprints: [
          {
            id: 'ancient-ruins-slot-0',
            label: 'Vanguard',
            role: 'vanguard',
            required: true,
            requirement: { label: 'Vanguard', anyOf: ['intelligence', 'perception'] },
          },
          {
            id: 'ancient-ruins-slot-1',
            label: 'Support',
            role: 'support',
            required: false,
            requirement: { label: 'Support', anyOf: ['agility', 'endurance'] },
          },
          {
            id: 'ancient-ruins-slot-2',
            label: 'Support',
            role: 'support',
            required: false,
            requirement: { label: 'Support', anyOf: ['agility', 'endurance'] },
    ...
    'herb-gathering': {
      ...
      maxSlots: 3,
      statRequirement: {
        label: 'Intelligence + Perception',
        allOf: ['intelligence'],
        anyOf: ['perception'],
      },
      rewards: [
        { resourceId: 'gold', amountFormula: '15' },
        { resourceId: 'xp', amountFormula: '30' },
        { resourceId: 'healing_herb', amountFormula: '5' },
        { resourceId: 'rare_herb', amountFormula: '1' },
      ],
      metadata: {
        icon: '🌿',
        narrative: 'Collect medicinal herbs from the surrounding wilderness.',
        injuryChanceDisplay: 5,
        deathChanceDisplay: 1,
        questDifficulty: 0.8,
        difficultyLabel: 'Facile',
        varianceCategory: 'safe',
        durationHours: 3,
        slotBlueprints: [
          {
            id: 'herb-gathering-slot-0',
            label: 'Gatherer',
            role: 'gatherer',
            required: true,
            requirement: { label: 'Gatherer', anyOf: ['intelligence', 'perception'] },
          },
          {
            id: 'herb-gathering-slot-1',
            label: 'Gatherer',
            role: 'gatherer',
            required: false,
            requirement: { label: 'Gatherer', anyOf: ['intelligence', 'perception'] },
