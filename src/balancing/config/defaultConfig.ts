...
const ADDITIONAL_STATS: Record<string, StatDefinition> = {
  ...
  baseHitChance: {
    id: 'baseHitChance',
    label: 'Base % to Hit',
    description: 'Baseline hit chance when TxC equals Evasion',
    type: 'percentage',
    min: 0,
    max: 100,
    step: 1,
  ...
  hitChance: {
    ...
    isCore: false,
    isDerived: true,
    formula: 'txc - evasion + baseHitChance',
    isHidden: true,
  },
  attacksPerKo: {
    id: 'attacksPerKo',
...
const DEFAULT_CARDS: Record<string, CardDefinition> = {
  ...
  txcHarmony: {
    ...
    color: 'text-cyan-300',
    icon: '🎯',
    statIds: ['txc', 'evasion', 'baseHitChance', 'hitChance', 'attacksPerKo'],
    isCore: false,
    order: 1,
    isLocked: false,
    isHidden: false,
...
export const DEFAULT_CONFIG: BalancerConfig = {
  ...
  scenarioBudget: {
    '1v1': { hpEq: 150, damageEq: 35.7 },
    'boss': { hpEq: 220, damageEq: 45.0 },
    'group': { hpEq: 180, damageEq: 40.0 },
    'swarm': { hpEq: 120, damageEq: 30.0 },
  },
};
