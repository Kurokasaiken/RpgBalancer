...
export interface BalancerConfig {
  ...
  /** Target turns for different combat scenarios */
  targetTurns: Record<string, number>;
  /** HP and damage equivalents for scenario balancing */
  scenarioBudget: Record<string, { hpEq: number; damageEq: number }>;
  /** Formula safety configuration for Phase 10 */
  formulaSafety?: {
