...
export class GridCombatSimulator {
    ...
    private static executeAoEDamageSpell(
        ...
        const targets = AoEModule.resolveTargets(
            targetPosition,
            spell.aoeShape as 'circle' | 'cone' | 'line',
            spell.aoeRadius as number,
            attacker.team,
            state.characters,
            state.grid,
    ...
    private static executeHealSpell(state: GridCombatState, caster: GridCombatCharacter, target: GridCombatCharacter, spell: Spell): void {
    ...
    private static executeBuffDebuff(state: GridCombatState, caster: GridCombatCharacter, target: GridCombatCharacter, spell: Spell): void {
