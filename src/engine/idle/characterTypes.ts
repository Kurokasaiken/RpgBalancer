...
export interface SavedCharacter {
  ...
  /** Optional visual profile reference consumed by Idle Village portrait resolver. */
  visualProfileId?: string;
  /** Optional direct portrait override URL. */
  portraitUrl?: string;
  /** Optional full-figure illustration override URL. */
  fullFigureUrl?: string;
  /** Optional badge crop override for portrait rendering. */
