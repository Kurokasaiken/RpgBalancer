...
export const PG_CARD_FRAME_CONFIG: Record<PgCardFrameType, PgCardFrameTokens> = {
  ...
  medallion: {
    label: 'Medallion',
    borderColor: 'var(--acc-primary-dark, #6a3c10)',
    backgroundColor: 'var(--skin-surface-base, rgba(12,11,9,0.85))',
    boxShadow: '0 2px 8px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.12)',
    accentColor: 'var(--acc-primary, #c07028)',
    borderWidth: 2,
    borderRadius: 'full',
  ...
  heroic: {
    label: 'Heroic',
    borderColor: 'var(--acc-primary, #c07028)',
    backgroundColor: 'var(--skin-surface-base, rgba(12,11,9,0.9))',
    boxShadow: '0 0 8px rgba(192,112,40,0.25), 0 4px 10px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.15)',
    accentColor: 'var(--acc-primary-light, #d89040)',
    borderWidth: 3,
    borderRadius: 'full',
    hasCornerDecorations: true,
    hasInnerBevel: true,
  ...
  veteran: {
    ...
    boxShadow: '0 0 12px rgba(141,179,165,0.3), 0 4px 10px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.12)',
  ...
  legendary: {
    ...
    boxShadow: '0 0 18px rgba(177,79,255,0.45), 0 6px 14px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.18)',
