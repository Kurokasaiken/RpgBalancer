...
export const ActivityCapsuleDetailSkinConfigSchema = z.object({
  ...
  presetId: z.enum(['base', 'minimal-frontier', 'minimal-wilderness', 'minimal-empire', 'wanderlust', 'arcane-tech', 'gilded-observatory', 'neon-cyber', 'shadow-realm']),
...
export const DEFAULT_ACTIVITY_CAPSULE_DETAIL_SKIN_CONFIG: ActivityCapsuleDetailSkinConfig = {
  ...
  typography: {
    ...
    textTertiary: 'rgba(138, 112, 80, 0.55)',
  ...
  wilderness: {
    // V9 Oily Prismatic Bronze & Wilderness Green
    window: {
      ...
      frameAmbientGlow: 'radial-gradient(circle at 50% 92%, rgba(0, 229, 255, 0.08) 0%, rgba(0, 229, 255, 0) 70%)',
