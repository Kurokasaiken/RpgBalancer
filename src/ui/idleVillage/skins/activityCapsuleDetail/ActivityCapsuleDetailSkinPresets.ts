...
export const BASE_LAYOUT_PRIMITIVES_PRESET: Partial<ActivityCapsuleDetailSkinConfig> = {
  window: {
    windowBackground: 'linear-gradient(160deg, rgba(1, 20, 35, 0.97) 0%, rgba(4, 15, 25, 0.99) 100%)',
    windowBorder: '1px solid rgba(0, 150, 200, 0.35)',
    frameGradient: 'linear-gradient(180deg, rgba(1, 25, 45, 0.96) 0%, rgba(2, 18, 32, 0.98) 50%, rgba(1, 12, 22, 0.99) 100%)',
