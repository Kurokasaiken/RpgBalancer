/**
 * DestinyAstrolabeV8 — V1 with reduced visual noise.
 *
 ...
 *
 * Single-line usage:
 *   <DestinyAstrolabeV8 skills={skills} onResolve={(r) => ...} autoStart />
 */
import React, { forwardRef, memo, useCallback, useEffect, useImperativeHandle, useRef, useState } from 'react';
import { useSkinBinding } from '@/ui/idleVillage/hooks/useSkinBinding';
import { createDestinyAstrolabeV8Engine } from './engine';
import type {
  AstrolabeSkill,
  AstrolabeConfig,
  AstrolabeResult,
...
export interface DestinyAstrolabeV8Handle {
  roll: () => void;
  throw: () => void;
}

export interface DestinyAstrolabeV8Props {
...
const SKIN_BINDING = {
  componentId: 'DestinyAstrolabeV8',
  name: 'DestinyAstrolabeV8',
...
export const DestinyAstrolabeV8 = memo(
  forwardRef<DestinyAstrolabeV8Handle, DestinyAstrolabeV8Props>(function DestinyAstrolabeV8(
    {
      skills,
      config,
      onResolve,
    ...
    useEffect(() => {
      ...
      const engine = createDestinyAstrolabeV8Engine(root, {
        skills,
        config,
        onResolve: (r) => {
...
DestinyAstrolabeV8.displayName = 'DestinyAstrolabeV8';
