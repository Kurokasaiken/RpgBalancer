/**
 * DestinyAstrolabeV10 — V1 with reduced visual noise.
 *
 ...
 *
 * Single-line usage:
 *   <DestinyAstrolabeV10 skills={skills} onResolve={(r) => ...} autoStart />
 */
import React, { forwardRef, memo, useCallback, useEffect, useImperativeHandle, useRef, useState } from 'react';
import { useSkinBinding } from '@/ui/idleVillage/hooks/useSkinBinding';
import { createDestinyAstrolabeV10Engine } from './engine';
import type {
  AstrolabeSkill,
  AstrolabeConfig,
  AstrolabeResult,
...
export interface DestinyAstrolabeV10Handle {
  roll: () => void;
  throw: () => void;
}

export interface DestinyAstrolabeV10Props {
...
const SKIN_BINDING = {
  componentId: 'DestinyAstrolabeV10',
  name: 'DestinyAstrolabeV10',
...
export const DestinyAstrolabeV10 = memo(
  forwardRef<DestinyAstrolabeV10Handle, DestinyAstrolabeV10Props>(function DestinyAstrolabeV10(
    {
      skills,
      config,
      onResolve,
    ...
    useEffect(() => {
      ...
      const engine = createDestinyAstrolabeV10Engine(root, {
        skills,
        config,
        onResolve: (r) => {
    ...
    return (
      <div className="destiny-astrolabe-wrap" style={{ position: 'relative', width: '100%', height: '100%' }}>
        <div
          ref={rootRef}
          data-testid="destiny-astrolabe-v7"
...
DestinyAstrolabeV10.displayName = 'DestinyAstrolabeV10';
