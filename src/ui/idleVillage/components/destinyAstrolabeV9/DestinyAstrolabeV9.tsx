/**
 * DestinyAstrolabeV9 — V1 with reduced visual noise.
 *
 ...
 *
 * Single-line usage:
 *   <DestinyAstrolabeV9 skills={skills} onResolve={(r) => ...} autoStart />
 */
import React, { forwardRef, memo, useCallback, useEffect, useImperativeHandle, useRef, useState } from 'react';
import { useSkinBinding } from '@/ui/idleVillage/hooks/useSkinBinding';
import { createDestinyAstrolabeV9Engine } from './engine';
import type {
  AstrolabeSkill,
  AstrolabeConfig,
  AstrolabeResult,
...
export interface DestinyAstrolabeV9Handle {
  roll: () => void;
  throw: () => void;
}

export interface DestinyAstrolabeV9Props {
...
const SKIN_BINDING = {
  componentId: 'DestinyAstrolabeV9',
  name: 'DestinyAstrolabeV9',
...
export const DestinyAstrolabeV9 = memo(
  forwardRef<DestinyAstrolabeV9Handle, DestinyAstrolabeV9Props>(function DestinyAstrolabeV9(
    {
      skills,
      config,
      onResolve,
    ...
    useEffect(() => {
      ...
      const engine = createDestinyAstrolabeV9Engine(root, {
        skills,
        config,
        onResolve: (r) => {
...
DestinyAstrolabeV9.displayName = 'DestinyAstrolabeV9';
