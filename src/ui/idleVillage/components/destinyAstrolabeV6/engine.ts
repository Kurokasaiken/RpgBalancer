...
export function createDestinyAstrolabeV6Engine(root: HTMLElement, opts: AstrolabeEngineOpts): AstrolabeEngineHandle {
  console.log('[engine] createDestinyAstrolabeV6Engine called, skills=', opts.skills?.map(s=>`${s.name}:${s.stat}/${s.difficulty}`));
