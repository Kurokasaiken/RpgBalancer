/**
 * DestinyAstrolabeV7 — V1 with reduced visual noise.
 *
 ...
 *
 * Single-line usage:
 *   <DestinyAstrolabeV7 skills={skills} onResolve={(r) => ...} autoStart />
 */
import React, { forwardRef, memo, useCallback, useEffect, useImperativeHandle, useRef, useState } from 'react';
import { useSkinBinding } from '@/ui/idleVillage/hooks/useSkinBinding';
import { createDestinyAstrolabeV7Engine } from './engine';
import type {
  AstrolabeSkill,
  AstrolabeConfig,
  AstrolabeResult,
...
export interface DestinyAstrolabeV7Handle {
  roll: () => void;
  throw: () => void;
}

export interface DestinyAstrolabeV7Props {
...
const SKIN_BINDING = {
  componentId: 'DestinyAstrolabeV7',
  name: 'DestinyAstrolabeV7',
...
export const DestinyAstrolabeV7 = memo(
  forwardRef<DestinyAstrolabeV7Handle, DestinyAstrolabeV7Props>(function DestinyAstrolabeV7(
    {
      skills,
      config,
      onResolve,
    ...
    useEffect(() => {
      ...
      const engine = createDestinyAstrolabeV7Engine(root, {
        skills,
        config,
        onResolve: (r) => {
...
DestinyAstrolabeV7.displayName = 'DestinyAstrolabeV7';
