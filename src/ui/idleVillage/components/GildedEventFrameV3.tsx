...
/**
 * Gilded decorative frame V3 for the event reminder.
 *
 * Adds a solar highlight along the top-left edge to simulate a milled
 * metal catch-light, while keeping the same continuous fillets and inset
 * cabochon gems as V2.
 */
export const GildedEventFrameV3: React.FC = () => {
  const { gilded, v3 } = eventReminderTokens;
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="gilded-v3-frame-gold" x1="0" y1="0" x2="1" y2="1">
        ...
        <linearGradient id="gilded-v3-highlight" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="rgba(255,255,255,0.75)" />
          <stop offset="35%" stopColor={v3.frameHighlight} />
          <stop offset="100%" stopColor="rgba(240,207,106,0)" />
        </linearGradient>
        <radialGradient id="gilded-v3-gem" cx="35%" cy="30%" r="70%">
          <stop offset="0%" stopColor={gilded.gemFace} />
          <stop offset="45%" stopColor={gilded.gemFill} />
          <stop offset="100%" stopColor={gilded.gemShadow} />
        </radialGradient>
        <filter id="gilded-v3-gem-glow" x="-80%" y="-80%" width="260%" height="260%">
        ...
        <filter id="gilded-v3-edge-glow" x="-20%" y="-20%" width="140%" height="140%">
      ...
      <path
        ...
        fill="none"
        stroke="url(#gilded-v3-frame-gold)"
        strokeWidth={4.5}
        vectorEffect="non-scaling-stroke"
      />

      {/* Top-left solar catch-light */}
      <path
        d="M 32 4 H 160 Q 170 4 170 14"
        fill="none"
        stroke="url(#gilded-v3-highlight)"
        strokeWidth={2.2}
        strokeLinecap="round"
        filter="url(#gilded-v3-edge-glow)"
        vectorEffect="non-scaling-stroke"
      />
      ...
      <g>
        {[
          ...
          <g key={`gem-v3-${cx}-${cy}`}>
            ...
            <circle cx={cx} cy={cy} r={5} fill="url(#gilded-v3-gem)" filter="url(#gilded-v3-gem-glow)" />
            <ellipse
              cx={cx - 1.4}
              cy={cy - 1.4}
              rx={1.8}
...
export default GildedEventFrameV3;
