          ...
          <div className="flex items-center gap-2 min-w-0">
            {isEditingHeader ? (
              ...
              <div className="flex items-center gap-1.5 min-w-0">
                <span className="text-base drop-shadow-md text-white">{displayIcon}</span>
                <p className="font-heroic text-[11px] font-bold tracking-widest uppercase truncate text-white">
                  {card.title}
                </p>
              </div>
            )}
