...
export const VillageNavigationShell: React.FC<VillageNavigationShellProps> = ({
  ...
  return (
    <>
      <div className="flex min-h-screen w-full overflow-hidden bg-(--surface-base) text-ivory">
        {!isMobile && (
                          ...
                          return (
                            <button
                              ...
                              className={[
                                ...
                                isActive
                                  ? 'text-amber-100 shadow-[0_0_25px_rgba(251,191,36,0.35)] active'
          ...
          {isMobile && (
            ...
            >
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full border border-(--panel-border) bg-black/40 flex items-center justify-center shadow-glow-gold">
      ...
      {isMobile && isDrawerOpen && (
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 max-h-[75vh] bg-(--surface-panel) rounded-t-3xl border-t border-white/10 overflow-hidden animate-slide-up">
