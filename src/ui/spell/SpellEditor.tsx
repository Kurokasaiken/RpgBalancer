                        ...
                        {['effect', 'cooldown', 'eco', 'aoe', 'dangerous', 'pierce'].map(field => {
                            ...
                            return (
                                <StatSlider
                                    ...
                                    field={field}
                                    label={label}
                                    value={(editedSpell as unknown as Record<string, unknown>)[field] as number || 0}
                                    baseline={(SPELL_CONFIG.baseline as unknown as Record<string, unknown>)[field] as number || 0}
