...
export const SpellInfoForm: React.FC<SpellInfoFormProps> = ({ spell, updateField }) => (
    <div className="mb-4 observatory-panel spell-panel-compact observatory-panel-ambient">
                ...
                <>
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 text-white px-3 py-1.5 rounded border border-white/10 focus:border-blue-400 focus:shadow-[0_0_8px_rgba(96,165,250,0.5)] outline-none transition-all"
                        />
                    </div>
                    <div>
