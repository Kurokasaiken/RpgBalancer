...
export const IdleArena: React.FC = () => {
    const [savedCharacters] = useState<SavedCharacter[]>(() => loadCharacters());
...
const CombatantCard: React.FC<{ combatant: Combatant, isActive: boolean, intent?: any }> = ({ combatant, isActive, intent }) => { // eslint-disable-line @typescript-eslint/no-explicit-any
