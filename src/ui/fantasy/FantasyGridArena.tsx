                ...
                entities: [
                    {
                        ...
                        stats: playerEntity.statBlock || { hp: playerEntity.derivedStats.maxHp, damage: playerEntity.derivedStats.attackPower } as StatBlock,
                    ...
                    ...enemyEntities.map((e, i) => ({
                        id: e.id,
                        name: e.name,
                        stats: e.statBlock || { hp: e.derivedStats.maxHp, damage: e.derivedStats.attackPower } as StatBlock,
            ...
            entities: [
                {
                    ...
                    stats: { hp: defaultChar1.hp, damage: defaultChar1.damage } as StatBlock,
                ...
                },
                {
                    ...
                    stats: { hp: defaultChar2.hp, damage: defaultChar2.damage } as StatBlock,
