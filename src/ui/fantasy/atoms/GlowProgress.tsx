...
export const GlowProgress: React.FC<GlowProgressProps> = ({
    ...
    const baseDims = SIZE_DIMENSIONS[size];
    const dims = {
        size: typeof sizePx === 'number' ? sizePx : baseDims.size,
        stroke: typeof strokeWidth === 'number' ? strokeWidth : baseDims.stroke,
    };
        ...
        >
            ...
            >
                ...
                <circle
                    ...
                    style={{
                        transition: enableTransitions ? 'stroke-dashoffset 0.3s ease-out' : 'none',
                    }}
                />
            </svg>
