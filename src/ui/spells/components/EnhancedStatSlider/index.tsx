...
/**
 * EnhancedStatSlider component
 * 
 * A multi-tick slider for spell stat configuration.
 * Each stat can have multiple value/weight pairs with drag-to-select functionality.
 * 
