/**
 * Simple Roster Payload Debug Script (JavaScript)
 * 
...
function savedCharacterToResident(hero, options) {
 ...
 */
function createMinimalGameplayPayload(residents) {
  return {
    state: {
 ...
 */
async function extractPayload(page, payloadKey) {
 ...
 */
function comparePayloads(testPayload, minimalPayload) {
...
module.exports = { debugRosterPayloads, createCanonicalResidentData, createMinimalGameplayPayload };
