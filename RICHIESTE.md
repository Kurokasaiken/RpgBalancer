...
- **Completati:** F4 resolution card, default teal tarato, trajectory state machine.
- **In esecuzione ora:** F3 — auto-throw con countdown, trigger espliciti `Space`/`Enter` sul `CHECK`, animazioni cornice per fase.
