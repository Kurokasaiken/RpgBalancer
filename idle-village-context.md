...
| outcomeKit | frozen-kit | candidate | `src/ui/idleVillage/frozen/kits/outcomeKit.tsx` + contract | `/minimal-outcome` | 2026-06-05 | OutcomeModal canonico — 4 esiti, CSS vars, telemetria. Nessun E2E ancora. |
| marketKit | frozen-kit | candidate | `src/ui/idleVillage/frozen/kits/marketKit.tsx` + contract | `/minimal-market` | 2026-06-05 | MarketActionCard canonico — 6 item, acquisto interattivo, CSS vars, telemetria. Nessun E2E ancora. |
| integrationQuestFlowKit | frozen-kit | candidate | `src/ui/idleVillage/frozen/kits/integrationQuestFlowKit.tsx` + contract | `/minimal-integration-quest-flow` | 2026-06-05 | Composizione QuestCard→SkillCheck→OutcomeModal. `data-testid="integration-quest-flow-root"`. Nessun E2E ancora. |
...
*Status: outcomeKit/marketKit/integrationQuestFlowKit promossi a candidate — privi di E2E, non ancora trusted/frozen*
